...
import time
import logging
from config.settings import GEMINI_API_KEY, AI_BATCH_SIZE, AI_RATE_LIMIT_DELAY
    ...
    def enhance_content(self, updates):
        ...
        for i in range(0, len(updates), AI_BATCH_SIZE):
            ...
            try:
                ...
                self.logger.error(f"Error processing batch with Gemini: {e}")
    ...
    def analyze_single_update(self, update):
        ...
        try:
            ...
            try:
                ...
                self.logger.warning("Gemini returned non-JSON response, using fallback")
                update.update({
